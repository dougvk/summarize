...
| Direct audio URLs | FAL/OpenAI Whisper | .mp3, .wav, .m4a, .aac, .ogg, .flac, .webm |
...
### 5. Direct Audio URL Transcription

Audio file URLs are detected and transcribed directly via FAL/OpenAI Whisper:
```bash
...
- `src/content/link-preview/transcript/providers/youtube/yt-dlp.ts` - Refactored to use shared transcribe module
- `src/content/link-preview/transcript/providers/audio.ts` - NEW: Direct audio URL transcription
- `src/content/link-preview/transcript/transcribe.ts` - NEW: Shared FAL/OpenAI transcription logic
- `src/content/link-preview/transcript/index.ts` - Added audio provider
- `src/content/link-preview/types.ts` - Added audio-fal, audio-openai sources
