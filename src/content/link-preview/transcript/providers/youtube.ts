...
export const fetchTranscript = async (
  ...
  if (mode === 'manual') {
    ...
    // No manual captions found, fall through to yt-dlp below
    notes.push('No manual captions found, using yt-dlp transcription')
  }
  ...
  // Try yt-dlp (audio download + OpenAI/FAL transcription) if mode is 'auto', 'manual', or 'yt-dlp'
  if (mode === 'yt-dlp' || mode === 'manual' || (mode === 'auto' && canRunYtDlp)) {
